...
const requiredUtmParams = ['utm_source', 'utm_campaign', 'utm_medium', 'utm_content'];
...
function work() {
  ...
  function rebuildLinks() {
    ...
    document.querySelectorAll('a').forEach(e => {
      ...
      const alreadyHaveRequiredUtmParams = requiredUtmParams.every(param => e.href.includes(param));
      if (alreadyHaveRequiredUtmParams) return;
  ...
  function rebuildForms() {
    ...
    forms.forEach(form => {
      const alreadyHaveRequiredUtmParams = requiredUtmParams.every(param => form.action.includes(param));
      if (alreadyHaveRequiredUtmParams) return;
